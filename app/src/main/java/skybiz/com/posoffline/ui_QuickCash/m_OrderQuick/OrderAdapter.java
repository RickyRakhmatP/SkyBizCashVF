...
public class OrderAdapter extends RecyclerView.Adapter<OrderHolder> {
    ...
    public OrderHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.model_orderquick,parent,false);
    ...
    public void onBindViewHolder(final OrderHolder holder, int position) {
        ...
        final String Qty            =String.format(Locale.US, "%,.0f",dQty);
        ...
        holder.txtDescription.setText(spacecraft.getDescription());
       // holder.txtUnitPrice.setText(Qty);
