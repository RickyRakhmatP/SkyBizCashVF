...
import skybiz.com.posoffline.ui_SalesOrder.m_UOM.DownloaderUOM;
...
public class Dialog_Qty extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnDelItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String vItemCode= (String) txtItemCode.getText();
                fndelitem(getActivity(),vItemCode);
                ((SalesOrder) getActivity()).refreshOrder();
                dismiss();
            }
        });
    ...
    private void retUOM(){
        ...
        DownloaderUOM downloaderUOM=new DownloaderUOM(getActivity(),ItemCode,rvUOM,Dialog_Qty.this);
    ...
    public void fnedititem(Context c, String vItemCode,String vQty, String vUnitPrice, String vHCDiscount, String vDisRate1){
        Log.d("CODE",vItemCode);
        AddItem_old fnedit=new AddItem_old(c,vItemCode, vQty, vUnitPrice,vHCDiscount,vDisRate1);
        fnedit.additem();
    }
    public void fndelitem(Context c, String ItemCode){
        DelItem fndel=new DelItem(c,ItemCode);
        fndel.delitem();
    }
