...
public class DownloadSupplier extends AsyncTask<Void,Void,String> {
    ...
    public DownloadSupplier(Context c, String SearchBy , String Keyword, RecyclerView rv, DialogSupplier dialogSupplier) {
        this.c = c;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result==null){
            ...
            SupplierParser p=new SupplierParser(c,result,rv,dialogSupplier);
            p.execute();
        }
    }
    ...
    private String downloadData(){
        try {
            ...
            String vClause="";
            if(SearchBy.equals("By Supplier Code")){
                vClause=" and CusCode like '%"+Keyword+"%' ";
            }else if(SearchBy.equals("By Supplier Name")){
            ...
            if(DBStatus.equals("1")){
                ...
                if (conn != null) {
                    String sql ="Select CusCode, CusName, TermCode, " +
                            "D_ay, SalesPersonCode, Tel, " +
                            " Fax from customer where FinCatCode='B70' "+vClause+" ";
                ...
                String vQuery="Select CusCode,CusName,TermCode," +
                        "D_ay, SalesPersonCode, Tel, " +
                        "Fax from customer where FinCatCode='B70' and CusCode<>'' "+vClause+" ";
                ...
                while(rsData.moveToNext()){
                    ...
                    row2.put("Tel",rsData.getString(5));
                    row2.put("Fax",rsData.getString(6));
                    results2.put(row2);
                }
                db.closeDB();
