...
public class AddMisc_ByMain extends AsyncTask<Void, Void, String> {
    ...
    public AddMisc_ByMain(Context c, String itemCode,String vDescription,
                          String vQty, String vUnitPrice, String vUOM,
                          String vDetailTaxCode,String vHCDiscount, String vDisRate1) {
        this.c = c;
        ItemCode = itemCode;
    ...
    private String addItem(String ItemCode,String Description, Double Qty, Double UnitPrice, String DetailTaxCode, String UOM, Double FactorQty, Double HCDiscount, Double DisRate1){
        ...
        try {
            ...
            String vSQLInsert = "INSERT INTO cloud_cus_inv_dt (Doc1No, N_o, ItemCode, Description, " +
                    ...
                    "ComputerName, SORunNo, ServiceChargeYN, LineNo)" +
                    "VALUES(" +
