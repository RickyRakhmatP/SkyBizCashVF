...
public class EditMisc extends AsyncTask<Void, Void, String> {
    Context c;
    String ItemCode,vQty,vUnitPrice,vHCDiscount,vDisRate1,vUOM,vDetailTaxCode;
    ...
    public EditMisc(Context c, String itemCode, String vQty, String vUnitPrice, String vUOM, String vDetailTaxCode, String vHCDiscount, String vDisRate1) {
        this.c = c;
        ItemCode = itemCode;
        this.vQty = vQty;
