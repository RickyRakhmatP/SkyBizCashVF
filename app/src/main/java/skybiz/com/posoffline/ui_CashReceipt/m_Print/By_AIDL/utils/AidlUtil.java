package skybiz.com.posoffline.ui_CashReceipt.m_Print.By_AIDL.utils;
...
import skybiz.com.posoffline.ui_CashReceipt.m_Print.By_AIDL.bean.TableItem;
...
public class AidlUtil {
     ...
     * 打印文字
     */
    public void printText2(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            Toast.makeText(context,"服务已断开！", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
           /* if (isBold) {
            ...
            //woyouService.printOriginalText(content, null);
