...
public class AddItem_ByMain extends AsyncTask<Void, Void, String> {
    ...
    public AddItem_ByMain(Context c, String itemCode, String vQty,
                          String vUnitPrice, String vHCDiscount, String vDisRate1,
                          String vPrinter, String vPoint) {
        this.c = c;
        ItemCode = itemCode;
        this.vQty = vQty;
    ...
    private String fnadd(){
        try{
            ...
            String vCheck="select RunNo,Qty,HCUnitCost, AnalysisCode2 from cloud_cus_inv_dt where" +
            ...
            if(DBStatus.equals("2")){
                ...
                while (curCheck.moveToNext()) {
                    ...
                    AnalysisCode2   = curCheck.getString(3);
                }
            }
            String vData="";
            if(dQty==0.00){
                ...
                if(!AnalysisCode2.equals("0")){
                    ...
                    if (GroupByItemYN.equals("0")) {
                        ...
                        vData = updateItem(RunNo, ItemCode, Qty, HCDiscount, DisRate1);
                    }
                }
            }
            db.closeDB();
    ...
    private String addItem(String ItemCode, Double Qty){
        ...
        JSONObject jsonReq,jsonRes;
        try {
            Double HCTax, HCLineAmt, DisRate1, TaxRate1,
            ...
            RetailTaxCode ="";
            Description   ="";
            String sql = "Select '' as RunNo, DefaultUOM, Description," +
                    " UOM, UOM1, UOM2," +
                    " UOM3, UOM4, IFNULL(UOMFactor1,'0') as UOMFactor1," +
                    " IFNULL(UOMFactor2,2) as UOMFactor2, IFNULL(UOMFactor3,'0') as UOMFactor3, IFNULL(UOMFactor4,'0') as UOMFactor4," +
                    ...
                    " SalesTaxCode, UnitPrice, IFNULL(MSP,0)as MSP, " +
                    " IFNULL(UnitCost,0)as UnitCost, ItemGroup " +
           ...
           // HCDiscount = 0.00;
            ...
            String vSQLInsert = "INSERT INTO cloud_cus_inv_dt (Doc1No, N_o, ItemCode, Description, " +
                    ...
                    "ComputerName, SORunNo, Printer,Point," +
                    "ServiceChargeYN, LineNo, ItemGroup)" +
                    "VALUES(" +
                    ...
                    " '" + datedNow + "', '0', 'CS', '0'," +
                    " '"+UserCode+"', '0' , '"+vPrinter+"','"+vPoint+"'," +
                    " '"+ServiceChargeYN+"', '"+LineNo+"', '"+vItemGroup+"')";
    ...
    private String updateItem(String RunNo ,String ItemCode, Double Qty ,Double HCDiscount,Double DisRate1){
