...
public class AddItemQuick extends AsyncTask<Void, Void, String> {
    Context c;
    ...
    int LineNo=0;
    public AddItemQuick(Context c, String vItemCode, String vDescription,
    ...
    private String fnadd(){
        try{
            ...
            UnitCost=Double.parseDouble(vUnitCost);
    ...
    private  void getDataMatrix(String B_ase,String C_ode, String C_ode2){
        try{
            ...
            while (rsMat1.next()) {
                ...
                String PeriodYN     = rsMat1.getString("PeriodYN");
                String vTimeStart   = rsMat1.getString("TimeStart");
                String vTimeEnd     = rsMat1.getString("TimeEnd");
                ...
                if(PeriodYN.equals("2")) {
                    ...
                    if( TimeStart.before(T_ime) && TimeEnd.after(T_ime)) {
                        ...
                        PriceMatrixDesc     = "";
                        //Log.d("PRICE MATRIX", vT_ime+" not range period time "+HCDiscount);
                    }
                }else{
                    HCDiscount           =newUnitPrice;
                    // PriceMatrixDesc     = "";
