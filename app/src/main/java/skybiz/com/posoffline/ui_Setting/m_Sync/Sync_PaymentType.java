...
public class Sync_PaymentType extends AsyncTask<Void,Integer,String> {
    Context c;
    ProgressBar barPay;
    ...
    public Sync_PaymentType(Context c, ProgressBar barPay) {
        this.c = c;
        this.barPay=barPay;
    }
