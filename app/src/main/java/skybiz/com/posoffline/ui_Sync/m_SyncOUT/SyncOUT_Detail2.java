...
public class SyncOUT_Detail2 extends AsyncTask<Void, Integer, String> {
    Context c;
    ProgressBar pgbar;
    ...
    public SyncOUT_Detail2(Context c, ProgressBar pgbar) {
        this.c = c;
        this.pgbar = pgbar;
    }
    ...
    protected void onProgressUpdate(Integer... values) {
        ...
        if (this.pgbar != null) {
           ...
           // ((Sync)c).SetProgressDtOut(T_ypeSync+" "+values[0] +" of "+ totalrows);
        }
    }
