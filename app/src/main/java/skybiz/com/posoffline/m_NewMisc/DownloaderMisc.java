...
public class DownloaderMisc extends AsyncTask<Void,Void,String> {
    ...
    public DownloaderMisc(Context c, String DocType, RecyclerView rv) {
        this.c = c;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result==null){
            ...
            MiscParser p=new MiscParser(c,DocType, result,rv);
            p.execute();
        }
    }
                ...
                if(ItemConn.equals("1")) {
                    ...
                    if (conn != null) {
                        String sql = "select '" + CurCode + "' as CurCode, '0' as Qty," +
                                " '' as PhotoFile, FORMAT(R_ate,2) as UnitPrice, OCCode," +
                                " Description, OCGroup as ItemGroup, UOM, RetailTaxCode from stk_othercharges where SuspendedYN='0'  ";
