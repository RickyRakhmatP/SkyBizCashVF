package skybiz.com.posoffline.m_dbms;//add your package name here example: package com.example.dbm;
...
import skybiz.com.posoffline.ui_Setting.m_Local.DBHelper;
	...
	//edit texts which has the values of the row which user has selected
      ...
      lp.setBackgroundColor(Color.WHITE);
  	  ...
  	  //spinner which displays update , delete options
          ...
          RelativeLayout.LayoutParams rlcrudparam = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT);
    	  	rlcrudparam.addRule(RelativeLayout.BELOW,lastrid);
		rlcrudparam.setMargins(8, 4, 4, 8);
