            ...
            if(DBStatus.equals("1")){
                if(ItemConn.equals("1")) {
                    ...
                    if (conn != null) {
                        ...
                        if (statement.execute(sql)) {
                            ...
                            while (resultSet.next()) {
                                ...
                                row.put("ItemGroup", charReplace(EncodeChar.setChar(c,resultSet.getString(7))));
                                row.put("Description", charReplace(EncodeChar.setChar(c,resultSet.getString(6))));
                                row.put("UnitPrice",resultSet.getString(4));
                                row.put("PhotoFile",resultSet.getString(3));
                                row.put("UOM", EncodeChar.setChar(c,resultSet.getString(8)));
                                ...
                                row.put("HCDiscount",resultSet.getString(12));
                                row.put("DisRate1",resultSet.getString(13));
                                results.put(row);
                            }
                            resultSet.close();
                        }
                    ...
                    while(rsData.moveToNext()){
                        ...
                        row2.put("HCDiscount",rsData.getString(11));
                        row2.put("DisRate1",rsData.getString(12));
                        results2.put(row2);
                    }
                    db.closeDB();
