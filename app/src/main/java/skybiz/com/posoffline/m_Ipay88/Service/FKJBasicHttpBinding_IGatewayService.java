...
public class FKJBasicHttpBinding_IGatewayService
{
    ...
    String url="http://www.mobile88.com/ePayment/WebService/MHGatewayService/GatewayService.svc";

    int timeOut=60000;
    public List< HeaderProperty> httpHeaders= new ArrayList< HeaderProperty>();
    public boolean enableLogging;

    public FKJBasicHttpBinding_IGatewayService(){}

    public FKJBasicHttpBinding_IGatewayService(String url)
    {
        this.url = url;
    }

    public FKJBasicHttpBinding_IGatewayService(String url,int timeOut)
    {
        this.url = url;
