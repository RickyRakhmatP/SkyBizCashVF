...
public class FKJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    
    static {
        classNames.put("http://schemas.datacontract.org/2004/07/MHPHGatewayService.Model^^ClientRequestModel",FKJClientRequestModel.class);
        classNames.put("http://schemas.datacontract.org/2004/07/MHPHGatewayService.Model^^ClientResponseModel",FKJClientResponseModel.class);
        classNames.put("http://schemas.datacontract.org/2004/07/System.ServiceModel^^FaultException",FKJFaultException.class);
        classNames.put("http://schemas.datacontract.org/2004/07/System.ServiceModel^^CommunicationException",FKJCommunicationException.class);
        classNames.put("http://schemas.datacontract.org/2004/07/System^^SystemException",FKJSystemException.class);
        classNames.put("http://schemas.datacontract.org/2004/07/System^^Exception",FKJException.class);
    } 
    ...
    public FKJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FKJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FKJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FKJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FKJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FKJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
