package skybiz.com.posoffline.m_Ipay88.User;
...
public class UserScan extends AppCompatActivity implements SurfaceHolder.Callback  {
    ...
    private void init() {
        ...
        asyncDecode = new AsyncDecode(UserScan.this);
        decode_count = 0;
    }
...
//            mCamera.setParameters(parameters);
    ...
    String resultado;
    private class RequestPayment extends AsyncTask<Void, Void, Boolean> {
        Context c;
