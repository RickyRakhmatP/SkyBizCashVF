...
public class Sync_SysGeneralSetup extends AsyncTask<Void, Void, String> {

    Context c;
    String IPAddress,DBName,UserName,Password,URL,DBStatus,ItemConn,
            z,sql,vDateFormat, NewDoc,Port;

    public Sync_SysGeneralSetup(Context c) {
        this.c = c;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result.equals("error")){
            Toast.makeText(c,"Failure sync in general setup", Toast.LENGTH_SHORT).show();
        }else if(result.equals("success")){
            Toast.makeText(c,"Successfull sync in general setup", Toast.LENGTH_SHORT).show();
