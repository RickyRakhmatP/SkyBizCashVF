...
public class Fragment_Summary extends Fragment {
    ...
    private void retOrder(){
        ...
        DownloaderOrder dOrder=new DownloaderOrder(getActivity(),"CusCN", rvOrder,getActivity().getSupportFragmentManager());
        dOrder.execute();
    }
    public void fnAddSearch(Context c, String ItemCode){
        String vQty="1";
        AddItem_BySearch fnaddsearch=new AddItem_BySearch(c, "CusCN", ItemCode,vQty);
        fnaddsearch.execute();
        //refresh();
    }
}
