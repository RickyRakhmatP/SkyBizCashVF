package skybiz.com.posoffline.m_Boost;
...
import skybiz.com.posoffline.m_Boost.UserScan.BoostUser;
...
public class DialogBoost extends DialogFragment {
    View view;
    ...
    private void scanUser(){
        ...
        Intent i=new Intent(getActivity(), BoostUser.class);
        i.putExtra("DOC1NO_KEY", Doc1No);
        i.putExtra("AMOUNT_KEY", Amount);
        i.putExtra("PAYID_KEY", PaymentId);
        i.putExtra("MERCHANTCODE_KEY", MerchantCode);
