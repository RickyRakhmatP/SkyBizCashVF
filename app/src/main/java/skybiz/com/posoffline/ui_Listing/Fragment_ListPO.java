...
import skybiz.com.posoffline.ui_Listing.m_ListPO.DownloaderList;
...
public class Fragment_ListPO extends Fragment {
    View view;
        ...
        btnPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* String DateFrom=txtDateFrom.getText().toString();
                String DateTo=txtDateTo.getText().toString();
                refresh(DateFrom,DateTo);
                //PrintList printList=new PrintList(getActivity(),"PO",DateFrom,DateTo);
                //printList.execute();*/
            }
        });
    ...
    public void refresh(String DateFrom,String DateTo) {
        rv=(RecyclerView)view.findViewById(R.id.rec_list_cs);
        rv.setHasFixedSize(true);
        lLayout = new GridLayoutManager(getActivity(), 1);
        rv.setLayoutManager(lLayout);
        rv.setItemAnimator(new DefaultItemAnimator());
        DownloaderList downloaderList=new DownloaderList(getActivity(),"PO",DateFrom,DateTo,rv);
