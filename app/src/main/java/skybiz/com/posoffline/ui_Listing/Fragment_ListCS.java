...
import skybiz.com.posoffline.ui_Listing.m_ListCS.TrnAdapter;
...
public class Fragment_ListCS extends Fragment {
    View view;
    ...
    private void fnPrint(){
        ...
        PrintList printList=new PrintList(getActivity(),"CS",T_ype,DateFrom,DateTo);
        printList.execute();
        refresh();
    }
    ...
    public void refresh() {
        ...
        DownloaderList downloaderList=new DownloaderList(getActivity(),"CS",DateFrom,DateTo,rvCashReceipt);
    ...
    public void retCS(String DateFrom,String DateTo){
        ...
        String vQuery="select H.Doc1No,H.D_ateTime,H.HCNetAmt," +
                ...
                "where H.DocType='CS' "+vClause+" Group By H.Doc1No Order By H.RunNo Desc";
