...
/**
 * Created by macair on 2/9/18.
 */

public class MyKeyboard_Order extends LinearLayout implements View.OnClickListener {
    // constructors
    public MyKeyboard_Order(Context context) {
        this(context, null, 0);
    }

    public MyKeyboard_Order(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyKeyboard_Order(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initialize buttons
        LayoutInflater.from(context).inflate(R.layout.button_order, this, true);
        ...
        mButtonDelete = (Button) findViewById(R.id.btnDel);
